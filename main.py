...
class HomePage(FloatLayout):
    ...
    wheel6 = StringProperty('wheel6.png')  # todo
    wheel7 = StringProperty('wheel7.png')  # wheel3,wheel4 asay karna hai to prevent lengthy
    ...
    # icon=StringProperty("Free_Sample.jpg")

    # height_always = (0.1 * Window.height)
    ...
    #  variable for saving textinputs
    variable_1 = StringProperty("")
    variable_2 = StringProperty("")
    variable_3 = StringProperty("")
    variable_4 = StringProperty("")
    variable_5 = StringProperty("")
    variable_6 = StringProperty("")
    variable_7 = StringProperty("")
    variable_8 = StringProperty("")
    variable_9 = StringProperty("")
    variable_10 = StringProperty("")
    variable_11 = StringProperty("")
    variable_12 = StringProperty("")
    variable_13 = StringProperty("")
    variable_14 = StringProperty("")
    variable_15 = StringProperty("")
    variable_16 = StringProperty("")
    variable_17 = StringProperty("")
    variable_18 = StringProperty("")
    variable_19 = StringProperty("")
    variable_20 = StringProperty("")
    variable_21 = StringProperty("")
    variable_22 = StringProperty("")
    variable_23 = StringProperty("")
    variable_24 = StringProperty("")
    variable_25 = StringProperty("")
    variable_26 = StringProperty("")
    variable_27 = StringProperty("")
    variable_28 = StringProperty("")
    variable_29 = StringProperty("")
    variable_30 = StringProperty("")
    variable_31 = StringProperty("")
    variable_32 = StringProperty("")
    variable_33 = StringProperty("")
    variable_34 = StringProperty("")
    variable_35 = StringProperty("")
    variable_36 = StringProperty("")

    def __init__(self, **kwargs):
        super(HomePage, self).__init__(**kwargs)
        self.ids.wheel_number.source = "wheel3.png"
    ...
    def change_background(self):
        if self.theme == 0:
            ...
            self.ids.delete_wheel.background_down = self.drop_down_button_theme_white_background_down
            self.ids.delete_wheel.background_normal = self.drop_down_button_theme_white_background_normal
            self.ids.delete_wheel.color = self.black
            ...
            self.ids.delete_wheel.background_down = self.drop_down_button_theme_black_background_down
            self.ids.delete_wheel.background_normal = self.drop_down_button_theme_black_background_normal
            self.ids.delete_wheel.color = self.white_without_opacity
    ...
    def save_wheel_1_open(self):
        if self.ids.save_wheel_1.text == "3 slot saved":
            self.ids.wheel_number.source = self.wheel3
            self.add_textbox_for_3()
            self.textinput_3_1.text = self.variable_1
            self.textinput_3_2.text = self.variable_2
            self.textinput_3_3.text = self.variable_3
        elif self.ids.save_wheel_1.text == "4 slot saved":
            self.ids.wheel_number.source = self.wheel4
            self.add_textbox_for_4()
            self.textinput_4_1.text = self.variable_1
            self.textinput_4_2.text = self.variable_2
            self.textinput_4_3.text = self.variable_3
            self.textinput_4_4.text = self.variable_4
        elif self.ids.save_wheel_1.text == "5 slot saved":
            self.ids.wheel_number.source = self.wheel5
            self.add_textbox_for_5()
            self.textinput_5_1.text = self.variable_1
            self.textinput_5_2.text = self.variable_2
            self.textinput_5_3.text = self.variable_3
            self.textinput_5_4.text = self.variable_4
            self.textinput_5_5.text = self.variable_5
        elif self.ids.save_wheel_1.text == "6 slot saved":
            self.ids.wheel_number.source = self.wheel6
            self.add_textbox_for_6()
            self.textinput_6_1.text = self.variable_1
            self.textinput_6_2.text = self.variable_2
            self.textinput_6_3.text = self.variable_3
            self.textinput_6_4.text = self.variable_4
            self.textinput_6_5.text = self.variable_5
            self.textinput_6_6.text = self.variable_6
        elif self.ids.save_wheel_1.text == "7 slot saved":
            self.ids.wheel_number.source = self.wheel7
            self.add_textbox_for_7()
            self.textinput_7_1.text = self.variable_1
            self.textinput_7_2.text = self.variable_2
            self.textinput_7_3.text = self.variable_3
            self.textinput_7_4.text = self.variable_4
            self.textinput_7_5.text = self.variable_5
            self.textinput_7_6.text = self.variable_6
            self.textinput_7_7.text = self.variable_7
        elif self.ids.save_wheel_1.text == "8 slot saved":
            self.ids.wheel_number.source = self.wheel8
            self.add_textbox_for_8()
            self.textinput_8_1.text = self.variable_1
            self.textinput_8_2.text = self.variable_2
            self.textinput_8_3.text = self.variable_3
            self.textinput_8_4.text = self.variable_4
            self.textinput_8_5.text = self.variable_5
            self.textinput_8_6.text = self.variable_6
            self.textinput_8_7.text = self.variable_7
            self.textinput_8_8.text = self.variable_8
        elif self.ids.save_wheel_1.text == "9 slot saved":
            self.ids.wheel_number.source = self.wheel9
            self.add_textbox_for_9()
            self.textinput_9_1.text = self.variable_1
            self.textinput_9_2.text = self.variable_2
            self.textinput_9_3.text = self.variable_3
            self.textinput_9_4.text = self.variable_4
            self.textinput_9_5.text = self.variable_5
            self.textinput_9_6.text = self.variable_6
            self.textinput_9_7.text = self.variable_7
            self.textinput_9_8.text = self.variable_8
            self.textinput_9_9.text = self.variable_9
        elif self.ids.save_wheel_1.text == "10 slot saved":
            self.ids.wheel_number.source = self.wheel10
            self.add_textbox_for_10()
            self.textinput_10_1.text = self.variable_1
            self.textinput_10_2.text = self.variable_2
            self.textinput_10_3.text = self.variable_3
            self.textinput_10_4.text = self.variable_4
            self.textinput_10_5.text = self.variable_5
            self.textinput_10_6.text = self.variable_6
            self.textinput_10_7.text = self.variable_7
            self.textinput_10_8.text = self.variable_8
            self.textinput_10_9.text = self.variable_9
            self.textinput_10_10.text = self.variable_10
        elif self.ids.save_wheel_1.text == "11 slot saved":
            self.ids.wheel_number.source = self.wheel11
            self.add_textbox_for_11()
            self.textinput_11_1.text = self.variable_1
            self.textinput_11_2.text = self.variable_2
            self.textinput_11_3.text = self.variable_3
            self.textinput_11_4.text = self.variable_4
            self.textinput_11_5.text = self.variable_5
            self.textinput_11_6.text = self.variable_6
            self.textinput_11_7.text = self.variable_7
            self.textinput_11_8.text = self.variable_8
            self.textinput_11_9.text = self.variable_9
            self.textinput_11_10.text = self.variable_10
            self.textinput_11_11.text = self.variable_11
        elif self.ids.save_wheel_1.text == "12 slot saved":
            self.ids.wheel_number.source = self.wheel12
            self.add_textbox_for_12()
            self.textinput_12_1.text = self.variable_1
            self.textinput_12_2.text = self.variable_2
            self.textinput_12_3.text = self.variable_3
            self.textinput_12_4.text = self.variable_4
            self.textinput_12_5.text = self.variable_5
            self.textinput_12_6.text = self.variable_6
            self.textinput_12_7.text = self.variable_7
            self.textinput_12_8.text = self.variable_8
            self.textinput_12_9.text = self.variable_9
            self.textinput_12_10.text = self.variable_10
            self.textinput_12_11.text = self.variable_11
            self.textinput_12_12.text = self.variable_12

    def save_wheel_2(self):
        self.ids.drop.dismiss()
        if self.theme == 0:
    ...
    def save_wheel_2_open(self):
        if self.ids.save_wheel_2.text == "3 slot saved":
            self.ids.wheel_number.source = self.wheel3
            self.add_textbox_for_3()
            self.textinput_3_1.text = self.variable_13
            self.textinput_3_2.text = self.variable_14
            self.textinput_3_3.text = self.variable_15
        elif self.ids.save_wheel_2.text == "4 slot saved":
            self.ids.wheel_number.source = self.wheel4
            self.add_textbox_for_4()
            self.textinput_4_1.text = self.variable_13
            self.textinput_4_2.text = self.variable_14
            self.textinput_4_3.text = self.variable_15
            self.textinput_4_4.text = self.variable_16
        elif self.ids.save_wheel_2.text == "5 slot saved":
            self.ids.wheel_number.source = self.wheel5
            self.add_textbox_for_5()
            self.textinput_5_1.text = self.variable_13
            self.textinput_5_2.text = self.variable_14
            self.textinput_5_3.text = self.variable_15
            self.textinput_5_4.text = self.variable_16
            self.textinput_5_5.text = self.variable_17
        elif self.ids.save_wheel_2.text == "6 slot saved":
            self.ids.wheel_number.source = self.wheel6
            self.add_textbox_for_6()
            self.textinput_6_1.text = self.variable_13
            self.textinput_6_2.text = self.variable_14
            self.textinput_6_3.text = self.variable_15
            self.textinput_6_4.text = self.variable_16
            self.textinput_6_5.text = self.variable_17
            self.textinput_6_6.text = self.variable_18
        elif self.ids.save_wheel_2.text == "7 slot saved":
            self.ids.wheel_number.source = self.wheel7
            self.add_textbox_for_7()
            self.textinput_7_1.text = self.variable_13
            self.textinput_7_2.text = self.variable_14
            self.textinput_7_3.text = self.variable_15
            self.textinput_7_4.text = self.variable_16
            self.textinput_7_5.text = self.variable_17
            self.textinput_7_6.text = self.variable_18
            self.textinput_7_7.text = self.variable_19
        elif self.ids.save_wheel_2.text == "8 slot saved":
            self.ids.wheel_number.source = self.wheel8
            self.add_textbox_for_8()
            self.textinput_8_1.text = self.variable_13
            self.textinput_8_2.text = self.variable_14
            self.textinput_8_3.text = self.variable_15
            self.textinput_8_4.text = self.variable_16
            self.textinput_8_5.text = self.variable_17
            self.textinput_8_6.text = self.variable_18
            self.textinput_8_7.text = self.variable_19
            self.textinput_8_8.text = self.variable_20
        elif self.ids.save_wheel_2.text == "9 slot saved":
            self.ids.wheel_number.source = self.wheel9
            self.add_textbox_for_9()
            self.textinput_9_1.text = self.variable_13
            self.textinput_9_2.text = self.variable_14
            self.textinput_9_3.text = self.variable_15
            self.textinput_9_4.text = self.variable_16
            self.textinput_9_5.text = self.variable_17
            self.textinput_9_6.text = self.variable_18
            self.textinput_9_7.text = self.variable_19
            self.textinput_9_8.text = self.variable_20
            self.textinput_9_9.text = self.variable_21
        elif self.ids.save_wheel_2.text == "10 slot saved":
            self.ids.wheel_number.source = self.wheel10
            self.add_textbox_for_10()
            self.textinput_10_1.text = self.variable_13
            self.textinput_10_2.text = self.variable_14
            self.textinput_10_3.text = self.variable_15
            self.textinput_10_4.text = self.variable_16
            self.textinput_10_5.text = self.variable_17
            self.textinput_10_6.text = self.variable_18
            self.textinput_10_7.text = self.variable_19
            self.textinput_10_8.text = self.variable_20
            self.textinput_10_9.text = self.variable_21
            self.textinput_10_10.text = self.variable_22
        elif self.ids.save_wheel_2.text == "11 slot saved":
            self.ids.wheel_number.source = self.wheel11
            self.add_textbox_for_11()
            self.textinput_11_1.text = self.variable_13
            self.textinput_11_2.text = self.variable_14
            self.textinput_11_3.text = self.variable_15
            self.textinput_11_4.text = self.variable_16
            self.textinput_11_5.text = self.variable_17
            self.textinput_11_6.text = self.variable_18
            self.textinput_11_7.text = self.variable_19
            self.textinput_11_8.text = self.variable_20
            self.textinput_11_9.text = self.variable_21
            self.textinput_11_10.text = self.variable_22
            self.textinput_11_11.text = self.variable_23
        elif self.ids.save_wheel_2.text == "12 slot saved":
            self.ids.wheel_number.source = self.wheel12
            self.add_textbox_for_12()
            self.textinput_12_1.text = self.variable_13
            self.textinput_12_2.text = self.variable_14
            self.textinput_12_3.text = self.variable_15
            self.textinput_12_4.text = self.variable_16
            self.textinput_12_5.text = self.variable_17
            self.textinput_12_6.text = self.variable_18
            self.textinput_12_7.text = self.variable_19
            self.textinput_12_8.text = self.variable_20
            self.textinput_12_9.text = self.variable_21
            self.textinput_12_10.text = self.variable_22
            self.textinput_12_11.text = self.variable_23
            self.textinput_12_12.text = self.variable_24

    def save_wheel_3(self):
        self.ids.drop.dismiss()
        if self.theme == 0:
    ...
    def save_wheel_3_open(self):
        if self.ids.save_wheel_3.text == "3 slot saved":
            self.ids.wheel_number.source = self.wheel3
            self.add_textbox_for_3()
            self.textinput_3_1.text = self.variable_25
            self.textinput_3_2.text = self.variable_26
            self.textinput_3_3.text = self.variable_27
        elif self.ids.save_wheel_3.text == "4 slot saved":
            self.ids.wheel_number.source = self.wheel4
            self.add_textbox_for_4()
            self.textinput_4_1.text = self.variable_25
            self.textinput_4_2.text = self.variable_26
            self.textinput_4_3.text = self.variable_27
            self.textinput_4_4.text = self.variable_28
        elif self.ids.save_wheel_3.text == "5 slot saved":
            self.ids.wheel_number.source = self.wheel5
            self.add_textbox_for_5()
            self.textinput_5_1.text = self.variable_25
            self.textinput_5_2.text = self.variable_26
            self.textinput_5_3.text = self.variable_27
            self.textinput_5_4.text = self.variable_28
            self.textinput_5_5.text = self.variable_29
        elif self.ids.save_wheel_3.text == "6 slot saved":
            self.ids.wheel_number.source = self.wheel6
            self.add_textbox_for_6()
            self.textinput_6_1.text = self.variable_25
            self.textinput_6_2.text = self.variable_26
            self.textinput_6_3.text = self.variable_27
            self.textinput_6_4.text = self.variable_28
            self.textinput_6_5.text = self.variable_29
            self.textinput_6_6.text = self.variable_30
        elif self.ids.save_wheel_3.text == "7 slot saved":
            self.ids.wheel_number.source = self.wheel7
            self.add_textbox_for_7()
            self.textinput_7_1.text = self.variable_25
            self.textinput_7_2.text = self.variable_26
            self.textinput_7_3.text = self.variable_27
            self.textinput_7_4.text = self.variable_28
            self.textinput_7_5.text = self.variable_29
            self.textinput_7_6.text = self.variable_30
            self.textinput_7_7.text = self.variable_31
        elif self.ids.save_wheel_3.text == "8 slot saved":
            self.ids.wheel_number.source = self.wheel8
            self.add_textbox_for_8()
            self.textinput_8_1.text = self.variable_25
            self.textinput_8_2.text = self.variable_26
            self.textinput_8_3.text = self.variable_27
            self.textinput_8_4.text = self.variable_28
            self.textinput_8_5.text = self.variable_29
            self.textinput_8_6.text = self.variable_30
            self.textinput_8_7.text = self.variable_31
            self.textinput_8_8.text = self.variable_32
        elif self.ids.save_wheel_3.text == "9 slot saved":
            self.ids.wheel_number.source = self.wheel9
            self.add_textbox_for_9()
            self.textinput_9_1.text = self.variable_25
            self.textinput_9_2.text = self.variable_26
            self.textinput_9_3.text = self.variable_27
            self.textinput_9_4.text = self.variable_28
            self.textinput_9_5.text = self.variable_29
            self.textinput_9_6.text = self.variable_30
            self.textinput_9_7.text = self.variable_31
            self.textinput_9_8.text = self.variable_32
            self.textinput_9_9.text = self.variable_33
        elif self.ids.save_wheel_3.text == "10 slot saved":
            self.ids.wheel_number.source = self.wheel10
            self.add_textbox_for_10()
            self.textinput_10_1.text = self.variable_25
            self.textinput_10_2.text = self.variable_26
            self.textinput_10_3.text = self.variable_27
            self.textinput_10_4.text = self.variable_28
            self.textinput_10_5.text = self.variable_29
            self.textinput_10_6.text = self.variable_30
            self.textinput_10_7.text = self.variable_31
            self.textinput_10_8.text = self.variable_32
            self.textinput_10_9.text = self.variable_33
            self.textinput_10_10.text = self.variable_34
        elif self.ids.save_wheel_3.text == "11 slot saved":
            self.ids.wheel_number.source = self.wheel11
            self.add_textbox_for_11()
            self.textinput_11_1.text = self.variable_25
            self.textinput_11_2.text = self.variable_26
            self.textinput_11_3.text = self.variable_27
            self.textinput_11_4.text = self.variable_28
            self.textinput_11_5.text = self.variable_29
            self.textinput_11_6.text = self.variable_30
            self.textinput_11_7.text = self.variable_31
            self.textinput_11_8.text = self.variable_32
            self.textinput_11_9.text = self.variable_33
            self.textinput_11_10.text = self.variable_34
            self.textinput_11_11.text = self.variable_35
        elif self.ids.save_wheel_3.text == "12 slot saved":
            self.ids.wheel_number.source = self.wheel12
            self.add_textbox_for_12()
            self.textinput_12_1.text = self.variable_25
            self.textinput_12_2.text = self.variable_26
            self.textinput_12_3.text = self.variable_27
            self.textinput_12_4.text = self.variable_28
            self.textinput_12_5.text = self.variable_29
            self.textinput_12_6.text = self.variable_30
            self.textinput_12_7.text = self.variable_31
            self.textinput_12_8.text = self.variable_32
            self.textinput_12_9.text = self.variable_33
            self.textinput_12_10.text = self.variable_34
            self.textinput_12_11.text = self.variable_35
            self.textinput_12_12.text = self.variable_36
    ...
    def save(self):
        if self.ids.save_wheel_3.text == 'No item saved':
            if self.ids.save_wheel_2.text == 'No item saved':
                if self.ids.save_wheel_1.text == 'No item saved':
                    self.ids.save_wheel_1.text = self.ids.slot_number.text + " slot saved"
                    if int(self.ids.slot_number.text) == 3:
                        self.variable_1 = str(self.textinput_3_1.text)
                        self.variable_2 = str(self.textinput_3_2.text)
                        self.variable_3 = str(self.textinput_3_3.text)
                    elif int(self.ids.slot_number.text) == 4:
                        self.variable_1 = str(self.textinput_4_1.text)
                        self.variable_2 = str(self.textinput_4_2.text)
                        self.variable_3 = str(self.textinput_4_3.text)
                        self.variable_4 = str(self.textinput_4_4.text)
                    elif int(self.ids.slot_number.text) == 5:
                        self.variable_1 = str(self.textinput_5_1.text)
                        self.variable_2 = str(self.textinput_5_2.text)
                        self.variable_3 = str(self.textinput_5_3.text)
                        self.variable_4 = str(self.textinput_5_4.text)
                        self.variable_5 = str(self.textinput_5_5.text)
                    elif int(self.ids.slot_number.text) == 6:
                        self.variable_1 = str(self.textinput_6_1.text)
                        self.variable_2 = str(self.textinput_6_2.text)
                        self.variable_3 = str(self.textinput_6_3.text)
                        self.variable_4 = str(self.textinput_6_4.text)
                        self.variable_5 = str(self.textinput_6_5.text)
                        self.variable_6 = str(self.textinput_6_6.text)
                    elif int(self.ids.slot_number.text) == 7:
                        self.variable_1 = str(self.textinput_7_1.text)
                        self.variable_2 = str(self.textinput_7_2.text)
                        self.variable_3 = str(self.textinput_7_3.text)
                        self.variable_4 = str(self.textinput_7_4.text)
                        self.variable_5 = str(self.textinput_7_5.text)
                        self.variable_6 = str(self.textinput_7_6.text)
                        self.variable_7 = str(self.textinput_7_7.text)
                    elif int(self.ids.slot_number.text) == 8:
                        self.variable_1 = str(self.textinput_8_1.text)
                        self.variable_2 = str(self.textinput_8_2.text)
                        self.variable_3 = str(self.textinput_8_3.text)
                        self.variable_4 = str(self.textinput_8_4.text)
                        self.variable_5 = str(self.textinput_8_5.text)
                        self.variable_6 = str(self.textinput_8_6.text)
                        self.variable_7 = str(self.textinput_8_7.text)
                        self.variable_8 = str(self.textinput_8_8.text)
                    elif int(self.ids.slot_number.text) == 9:
                        self.variable_1 = str(self.textinput_9_1.text)
                        self.variable_2 = str(self.textinput_9_2.text)
                        self.variable_3 = str(self.textinput_9_3.text)
                        self.variable_4 = str(self.textinput_9_4.text)
                        self.variable_5 = str(self.textinput_9_5.text)
                        self.variable_6 = str(self.textinput_9_6.text)
                        self.variable_7 = str(self.textinput_9_7.text)
                        self.variable_8 = str(self.textinput_9_8.text)
                        self.variable_9 = str(self.textinput_9_9.text)
                    elif int(self.ids.slot_number.text) == 10:
                        self.variable_1 = str(self.textinput_10_1.text)
                        self.variable_2 = str(self.textinput_10_2.text)
                        self.variable_3 = str(self.textinput_10_3.text)
                        self.variable_4 = str(self.textinput_10_4.text)
                        self.variable_5 = str(self.textinput_10_5.text)
                        self.variable_6 = str(self.textinput_10_6.text)
                        self.variable_7 = str(self.textinput_10_7.text)
                        self.variable_8 = str(self.textinput_10_8.text)
                        self.variable_9 = str(self.textinput_10_9.text)
                        self.variable_10 = str(self.textinput_10_10.text)
                    elif int(self.ids.slot_number.text) == 11:
                        self.variable_1 = str(self.textinput_11_1.text)
                        self.variable_2 = str(self.textinput_11_2.text)
                        self.variable_3 = str(self.textinput_11_3.text)
                        self.variable_4 = str(self.textinput_11_4.text)
                        self.variable_5 = str(self.textinput_11_5.text)
                        self.variable_6 = str(self.textinput_11_6.text)
                        self.variable_7 = str(self.textinput_11_7.text)
                        self.variable_8 = str(self.textinput_11_8.text)
                        self.variable_9 = str(self.textinput_11_9.text)
                        self.variable_10 = str(self.textinput_11_10.text)
                        self.variable_11 = str(self.textinput_11_11.text)
                    elif int(self.ids.slot_number.text) == 12:
                        self.variable_1 = str(self.textinput_12_1.text)
                        self.variable_2 = str(self.textinput_12_2.text)
                        self.variable_3 = str(self.textinput_12_3.text)
                        self.variable_4 = str(self.textinput_12_4.text)
                        self.variable_5 = str(self.textinput_12_5.text)
                        self.variable_6 = str(self.textinput_12_6.text)
                        self.variable_7 = str(self.textinput_12_7.text)
                        self.variable_8 = str(self.textinput_12_8.text)
                        self.variable_9 = str(self.textinput_12_9.text)
                        self.variable_10 = str(self.textinput_12_10.text)
                        self.variable_11 = str(self.textinput_12_11.text)
                        self.variable_12 = str(self.textinput_12_12.text)
                else:
                    self.ids.save_wheel_2.text = self.ids.slot_number.text + " slot saved"
                    if int(self.ids.slot_number.text) == 3:
                        self.variable_13 = str(self.textinput_3_1.text)
                        self.variable_14 = str(self.textinput_3_2.text)
                        self.variable_15 = str(self.textinput_3_3.text)
                    elif int(self.ids.slot_number.text) == 4:
                        self.variable_13 = str(self.textinput_4_1.text)
                        self.variable_14 = str(self.textinput_4_2.text)
                        self.variable_15 = str(self.textinput_4_3.text)
                        self.variable_16 = str(self.textinput_4_4.text)
                    elif int(self.ids.slot_number.text) == 5:
                        self.variable_13 = str(self.textinput_5_1.text)
                        self.variable_14 = str(self.textinput_5_2.text)
                        self.variable_15 = str(self.textinput_5_3.text)
                        self.variable_16 = str(self.textinput_5_4.text)
                        self.variable_17 = str(self.textinput_5_5.text)
                    elif int(self.ids.slot_number.text) == 6:
                        self.variable_13 = str(self.textinput_6_1.text)
                        self.variable_14 = str(self.textinput_6_2.text)
                        self.variable_15 = str(self.textinput_6_3.text)
                        self.variable_16 = str(self.textinput_6_4.text)
                        self.variable_17 = str(self.textinput_6_5.text)
                        self.variable_18 = str(self.textinput_6_6.text)
                    elif int(self.ids.slot_number.text) == 7:
                        self.variable_13 = str(self.textinput_7_1.text)
                        self.variable_14 = str(self.textinput_7_2.text)
                        self.variable_15 = str(self.textinput_7_3.text)
                        self.variable_16 = str(self.textinput_7_4.text)
                        self.variable_17 = str(self.textinput_7_5.text)
                        self.variable_18 = str(self.textinput_7_6.text)
                        self.variable_19 = str(self.textinput_7_7.text)
                    elif int(self.ids.slot_number.text) == 8:
                        self.variable_13 = str(self.textinput_8_1.text)
                        self.variable_14 = str(self.textinput_8_2.text)
                        self.variable_15 = str(self.textinput_8_3.text)
                        self.variable_16 = str(self.textinput_8_4.text)
                        self.variable_17 = str(self.textinput_8_5.text)
                        self.variable_18 = str(self.textinput_8_6.text)
                        self.variable_19 = str(self.textinput_8_7.text)
                        self.variable_20 = str(self.textinput_8_8.text)
                    elif int(self.ids.slot_number.text) == 9:
                        self.variable_13 = str(self.textinput_9_1.text)
                        self.variable_14 = str(self.textinput_9_2.text)
                        self.variable_15 = str(self.textinput_9_3.text)
                        self.variable_16 = str(self.textinput_9_4.text)
                        self.variable_17 = str(self.textinput_9_5.text)
                        self.variable_18 = str(self.textinput_9_6.text)
                        self.variable_19 = str(self.textinput_9_7.text)
                        self.variable_20 = str(self.textinput_9_8.text)
                        self.variable_21 = str(self.textinput_9_9.text)
                    elif int(self.ids.slot_number.text) == 10:
                        self.variable_13 = str(self.textinput_10_1.text)
                        self.variable_14 = str(self.textinput_10_2.text)
                        self.variable_15 = str(self.textinput_10_3.text)
                        self.variable_16 = str(self.textinput_10_4.text)
                        self.variable_17 = str(self.textinput_10_5.text)
                        self.variable_18 = str(self.textinput_10_6.text)
                        self.variable_19 = str(self.textinput_10_7.text)
                        self.variable_20 = str(self.textinput_10_8.text)
                        self.variable_21 = str(self.textinput_10_9.text)
                        self.variable_22 = str(self.textinput_10_10.text)
                    elif int(self.ids.slot_number.text) == 11:
                        self.variable_13 = str(self.textinput_11_1.text)
                        self.variable_14 = str(self.textinput_11_2.text)
                        self.variable_15 = str(self.textinput_11_3.text)
                        self.variable_16 = str(self.textinput_11_4.text)
                        self.variable_17 = str(self.textinput_11_5.text)
                        self.variable_18 = str(self.textinput_11_6.text)
                        self.variable_19 = str(self.textinput_11_7.text)
                        self.variable_20 = str(self.textinput_11_8.text)
                        self.variable_21 = str(self.textinput_11_9.text)
                        self.variable_22 = str(self.textinput_11_10.text)
                        self.variable_23 = str(self.textinput_11_11.text)
                    elif int(self.ids.slot_number.text) == 12:
                        self.variable_13 = str(self.textinput_12_1.text)
                        self.variable_14 = str(self.textinput_12_2.text)
                        self.variable_15 = str(self.textinput_12_3.text)
                        self.variable_16 = str(self.textinput_12_4.text)
                        self.variable_17 = str(self.textinput_12_5.text)
                        self.variable_18 = str(self.textinput_12_6.text)
                        self.variable_19 = str(self.textinput_12_7.text)
                        self.variable_20 = str(self.textinput_12_8.text)
                        self.variable_21 = str(self.textinput_12_9.text)
                        self.variable_22 = str(self.textinput_12_10.text)
                        self.variable_23 = str(self.textinput_12_11.text)
                        self.variable_24 = str(self.textinput_12_12.text)
            else:
                self.ids.save_wheel_3.text = self.ids.slot_number.text + " slot saved"
                if int(self.ids.slot_number.text) == 3:
                    self.variable_25 = str(self.textinput_3_1.text)
                    self.variable_26 = str(self.textinput_3_2.text)
                    self.variable_27 = str(self.textinput_3_3.text)
                elif int(self.ids.slot_number.text) == 4:
                    self.variable_25 = str(self.textinput_4_1.text)
                    self.variable_26 = str(self.textinput_4_2.text)
                    self.variable_27 = str(self.textinput_4_3.text)
                    self.variable_28 = str(self.textinput_4_4.text)
                elif int(self.ids.slot_number.text) == 5:
                    self.variable_25 = str(self.textinput_5_1.text)
                    self.variable_26 = str(self.textinput_5_2.text)
                    self.variable_27 = str(self.textinput_5_3.text)
                    self.variable_28 = str(self.textinput_5_4.text)
                    self.variable_29 = str(self.textinput_5_5.text)
                elif int(self.ids.slot_number.text) == 6:
                    self.variable_25 = str(self.textinput_6_1.text)
                    self.variable_26 = str(self.textinput_6_2.text)
                    self.variable_27 = str(self.textinput_6_3.text)
                    self.variable_28 = str(self.textinput_6_4.text)
                    self.variable_29 = str(self.textinput_6_5.text)
                    self.variable_30 = str(self.textinput_6_6.text)
                elif int(self.ids.slot_number.text) == 7:
                    self.variable_25 = str(self.textinput_7_1.text)
                    self.variable_26 = str(self.textinput_7_2.text)
                    self.variable_27 = str(self.textinput_7_3.text)
                    self.variable_28 = str(self.textinput_7_4.text)
                    self.variable_29 = str(self.textinput_7_5.text)
                    self.variable_30 = str(self.textinput_7_6.text)
                    self.variable_31 = str(self.textinput_7_7.text)
                elif int(self.ids.slot_number.text) == 8:
                    self.variable_25 = str(self.textinput_8_1.text)
                    self.variable_26 = str(self.textinput_8_2.text)
                    self.variable_27 = str(self.textinput_8_3.text)
                    self.variable_28 = str(self.textinput_8_4.text)
                    self.variable_29 = str(self.textinput_8_5.text)
                    self.variable_30 = str(self.textinput_8_6.text)
                    self.variable_31 = str(self.textinput_8_7.text)
                    self.variable_32 = self.textinput_8_8
                elif int(self.ids.slot_number.text) == 9:
                    self.variable_25 = str(self.textinput_9_1.text)
                    self.variable_26 = str(self.textinput_9_2.text)
                    self.variable_27 = str(self.textinput_9_3.text)
                    self.variable_28 = str(self.textinput_9_4.text)
                    self.variable_29 = str(self.textinput_9_5.text)
                    self.variable_30 = str(self.textinput_9_6.text)
                    self.variable_31 = str(self.textinput_9_7.text)
                    self.variable_32 = str(self.textinput_9_8.text)
                    self.variable_33 = str(self.textinput_9_9.text)
                elif int(self.ids.slot_number.text) == 10:
                    self.variable_25 = str(self.textinput_10_1.text)
                    self.variable_26 = str(self.textinput_10_2.text)
                    self.variable_27 = str(self.textinput_10_3.text)
                    self.variable_28 = str(self.textinput_10_4.text)
                    self.variable_29 = str(self.textinput_10_5.text)
                    self.variable_30 = str(self.textinput_10_6.text)
                    self.variable_31 = str(self.textinput_10_7.text)
                    self.variable_32 = str(self.textinput_10_8.text)
                    self.variable_33 = str(self.textinput_10_9.text)
                    self.variable_34 = str(self.textinput_10_10.text)
                elif int(self.ids.slot_number.text) == 11:
                    self.variable_25 = str(self.textinput_11_1.text)
                    self.variable_26 = str(self.textinput_11_2.text)
                    self.variable_27 = str(self.textinput_11_3.text)
                    self.variable_28 = str(self.textinput_11_4.text)
                    self.variable_29 = str(self.textinput_11_5.text)
                    self.variable_30 = str(self.textinput_11_6.text)
                    self.variable_31 = str(self.textinput_11_7.text)
                    self.variable_32 = str(self.textinput_11_8.text)
                    self.variable_33 = str(self.textinput_11_9.text)
                    self.variable_34 = str(self.textinput_11_10.text)
                    self.variable_35 = str(self.textinput_11_11.text)
                elif int(self.ids.slot_number.text) == 12:
                    self.variable_25 = str(self.textinput_12_1.text)
                    self.variable_26 = str(self.textinput_12_2.text)
                    self.variable_27 = str(self.textinput_12_3.text)
                    self.variable_28 = str(self.textinput_12_4.text)
                    self.variable_29 = str(self.textinput_12_5.text)
                    self.variable_30 = str(self.textinput_12_6.text)
                    self.variable_31 = str(self.textinput_12_7.text)
                    self.variable_32 = str(self.textinput_12_8.text)
                    self.variable_33 = str(self.textinput_12_9.text)
                    self.variable_34 = str(self.textinput_12_10.text)
                    self.variable_35 = str(self.textinput_12_11.text)
                    self.variable_36 = str(self.textinput_12_12.text)
        return
    ...
    def notification_alarm_for_5(self, _):
        plyer.notification.notify(title="Spinning",
                                  ...
                                  app_name="SpinToDo")
        # app_icon=self.icon)  # timeout=10 can also be given
        # print("This is reminder for spinning wheel to do work")
